...
<html lang="es">
    ...
    <body>
        ...
        <main class="contenedor-inventario">
            ...
            <!-- Franja de título a todo el ancho -->
            <section class="franja-titulo-foto-fondo franja-titulo-foto-fondo--pizarra"
                     style="background-image:url('${pageContext.request.contextPath}/Recursos/Imagenes/Layout1.jpg')">

                <div class="container">

                    <div class="icono-circulo icono-circulo-pizarra">
                    ...
                    <p class="texto-introductorio">
                        Ejemplares físicos y digitales de cada libro del catálogo.
                    </p>
                ...
                <div class="bloque-buscador row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text"
                               id="buscar-ejemplar"
                               class="form-control"
                               placeholder="Buscar por libro o código...">
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="filtro-estado-ejemplar"
                                class="form-select campo-filtro">
