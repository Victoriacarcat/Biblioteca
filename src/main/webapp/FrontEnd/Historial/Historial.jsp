...
<head>
    <meta charset="UTF-8">
    <title>Historial de préstamos - Wisebooks</title>
...
<body>
    ...
    <main class="contenedor-historial container">
        ...
        <section class="franja-titulo">
            ...
            <h1 class="titulo-historial">Historial de préstamos</h1>
            <p class="texto-introductorio">Libros que ya devolviste, con sus fechas de préstamo y devolución.</p>
        </section>
    ...
    <script src="${pageContext.request.contextPath}/Recursos/JS/Historial.js"></script>
</body>
</html>
